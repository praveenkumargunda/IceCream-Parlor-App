    ...
    2.) Insert all the files related to the project in one single folder and create a file name "Dockerfile" in it and also create a text file named
    "requiremnts.txt".
    3.)Give the above commands in Dockerfile and also and mention if we have any other dependencies mention them in the requirments file so that they can be 
